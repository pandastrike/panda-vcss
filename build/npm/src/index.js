...
var CSS, Properties, Styles, Units, Value, isArray, isDefined, isEmpty, isFunction, isObject, mix, render, units;
...
// TODO: We need to use duck-typing here
...
_fairmontMultimethods.Method.define(render, (0, _fairmontHelpers.isType)(Function), function (mixin) {
  return render(mixin());
});
